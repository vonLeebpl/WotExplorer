...
class RefreshOldTanksCommand extends ContainerAwareCommand
{
    /**
     * @see Command
     */
    ...
    {
        $this
            ->setName('app:refresh:oldtanks')
            ->setDescription('Refresh tanks from deprecated vehicle list WOT API')
            ->setHelp(<<<EOT
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $manipulator->refreshWotOldTanks();
